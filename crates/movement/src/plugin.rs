...
/// Registers movement dispatch for every embodiment implemented so far.
/// Adding `CarLike`/`FullVehicle` later means adding one more
/// `apply_movement_force::<M>` line here, nothing else.
